...
def main() -> None:
    ...
    # First-time setup: if config.json is missing or incomplete, launch wizard
    if not config.is_complete() or not os.path.exists("config.json"):
        logger.info("First-time setup — launching setup wizard...")
        try:
            ...
            # Friendly error to console if wizard fails (no traceback for client)
            print("\n")
            print("  ================================================")
            print("   SETUP ERROR")
            print("  ================================================")
            ...
            print("")
            logger.error(f"Wizard failed: {wiz_err}")
            sys.exit(1)
    ...
    try:
        ...
        logger.error(f"Fatal error: {tb}")
        # Friendly error for non-technical client (kept in console)
        print("\n")
        print("  ================================================")
        print("   UNEXPECTED ERROR")
        print("  ================================================")
        print("")
        print("   The Worker encountered a problem.")
        print("   Please try the following:")
        print("     1. Make sure the Controller is running")
        print("     2. Check your network connection")
        print("     3. Restart your computer and try again")
        print("     4. Contact support for help")
        print("")
        print("   Log file: C:\\RenderAgent\\logs\\worker.log")
        print("  ================================================")
        print("\n")
